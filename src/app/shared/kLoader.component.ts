...
@Component({
    ...
    template:
        ...
        <g id="kLogo">
			...
			<path id="kCircle" fill="none" stroke="#FFF" stroke-width="9" stroke-linecap="round"
				stroke-miterlimit="10"
				d="M58.68 10.813c26.436 0
				47.867 21.43 47.867 47.866s-21.43 47.867-47.866 47.867c-26.437 0-47.868-21.432-47.868-47.868 0-26.436 21.43-47.867 47.87-47.867"/>
        ...
        <g id="paths" fill="none" stroke="#30EFEF" stroke-linecap="square" stroke-miterlimit="10">
			<path id="path1" stroke-width=".206"
				d="M28.932 58.254c-2.09-4.337-3.26-9.2-3.26-14.337
				0-18.264 14.805-33.07 33.07-33.07l-.062-.034c26.435
				0 47.865 21.43 47.865 47.866s-21.43 47.867-47.866 47.867c-26.44 0-47.87-21.432-47.87-47.868 0-26.436 21.43-47.867 47.87-47.867"/>
			<path id="path4" stroke-width=".233"
				d="M88.676 58.68c0 21.505-17.434
				38.94-38.94 38.94-21.507 0-38.94-17.436-38.94-38.94l.016-.002c0-26.435
				21.43-47.866 47.87-47.866v.14c20.583 0 37.27 16.687 37.27 37.272 0 12.926-6.58 24.315-16.572 31"/>
			<path id="path3" stroke-width=".299"
				d="M68.51 58.46c0 15.94-12.92 28.858-28.856
				28.858-15.938 0-28.858-12.92-28.858-28.857l.017.22c0-26.436 21.43-47.867
				47.87-47.867v.142c17.868 0 32.355 14.488 32.355 32.356 0 17.87-14.487 32.357-32.356 32.357-4.463 0-8.716-.904-12.584-2.538"/>
			<path id="path2" stroke-width=".212"
				d="M48.714 58.775C39.892 54.928 33.726 46.13 33.726 35.89c0-13.78
				11.172-24.953 24.954-24.953v-.125c26.436 0 47.867 21.43 47.867 47.866h.124c0
				18.73-15.183 33.915-33.912 33.915-18.73 0-33.916-15.184-33.916-33.915 0-7.834 2.657-15.047 7.118-20.79"/>
        </g>
		</svg:g>`
})
export class  KLoaderComponent implements OnInit, AfterViewInit{
	...
	kAnimation(){
		...
		const path4 = MorphSVGPlugin.pathDataToBezier('#path4', {align: 'relative'});
		const path3 = MorphSVGPlugin.pathDataToBezier('#path3', {align: 'relative'});
		const path2 = MorphSVGPlugin.pathDataToBezier('#path2', {align: 'relative'});
		const path1 = MorphSVGPlugin.pathDataToBezier('#path1', {align: 'relative'});
